...
def laplacian_matrix_2d(Nx=3,Ny=3,bc='AllSidesClamped'):
  """
  this function generates the discrete laplacian operator in matrix form operating over a 2D grid of size (Nx - 1)*(Ny - 1)
  """
...
def biharm_matrix_2d(Nx=3,Ny=3,bc='AllSidesClamped'):
  """
  this function generates the discrete biharmonic operator in matrix form operating over a 2D grid of size (Nx - 1)*(Ny - 1)
  """
  checkInputArgs(Nx,Ny,bc)
