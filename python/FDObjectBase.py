class FDObjectBase(object):
  ...
  def calcUpdateMatrices(self):
    raise NotImplementedError('calcUpdateMatrices should not be called from class %s' % self.__class__.__name__)
